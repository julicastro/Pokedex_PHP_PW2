...
<body style="background: #d2c575;font-family: cursive;" style="text-align: -webkit-center;">
    ...
    <form action="buscar.php" method="GET" class="my-5">
        <div class="form-group d-flex w-50 m-auto">
            <input type="text" name="busqueda" id="busqueda" placeholder="Buscar" class="form-control" value="<?php echo $busqueda; ?>">
    ...
    <div style="width: 90%" class="m-auto">
        ...
        <table class="table">
            ...
            <tbody>
                <?php foreach (PokemonDAO::listarDatosFiltrado($busqueda) as $fila) { ?>
                    <tr>
                        <td><?= $fila[0] ?></td>
